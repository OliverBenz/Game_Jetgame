...
public class Actor_PlayerLeft {
	...
	public Actor_PlayerLeft(float x, float y) throws SlickException {
		super();
		this.x = x;
		this.y = y;
		this.health = 5;
	...
	public void render(Graphics g) {
		g.drawImage(this.player, this.x, this.y, this.x + 128, this.y + 128, 0, 0, 960, 960);
	}
	...
	public void moveRight(int millisSinceLastCall) {
		if (this.x < 1920 / 2 - this.width - 10) {
			this.x += millisSinceLastCall * SPEED;
		}
	}
